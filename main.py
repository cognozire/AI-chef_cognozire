...
def main():
    ...
    #RECOMMENDING BOOKS BASED ON USER'S FAVOURITE MOVIE(CROSS RECOMMENDATION)
        ...
        st.markdown('<p>Choose 3 Options from each category and move to result Page.</p>', unsafe_allow_html=True)
